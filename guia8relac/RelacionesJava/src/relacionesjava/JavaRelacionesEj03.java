...
import relacionesjava.Services.BarajaService;
...
public class JavaRelacionesEj03 {
    ...
    public static void main(String[] args) {
        ...
        Baraja mazo=barServ.creaBaraja();
        barServ.mostrarBaraja(mazo);
        barServ.barajarMazo(mazo);
        barServ.mostrarBaraja(mazo);
        barServ.cartasDisponibles(mazo);
        barServ.darCartas(mazo);
        barServ.cartasDisponibles(mazo);
        barServ.cartasMonton(mazo);
        barServ.mostrarBaraja(mazo);
